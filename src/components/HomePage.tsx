  ...
  ht: {
    ...
    programs: {
      ...
      card2: {
        ...
        desc: "Fòme tèt ou nan agimantasyon rigourèz, analiz kritik tèks, epi prepare pou egzamen kilti jeneral ki endispansab pou kèk espesyalizasyon nan zafè ak prive.",
        feats: [
